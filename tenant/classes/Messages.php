...
/**
 * handles methods for viewing messages
 * @author Sire
 * @link null
 * @link null
 * @license null
...
class Messages
{
    ...
    public function sendMessage($tenant_id, $message) {
        if ($this->databaseConnection()) {
            ...
            $sql = "INSERT INTO tbl_messages (tenant_id, send_to, message, message_datetime) VALUES(:tenant_id, 'admin', :message, :message_datetime)";
            try {
