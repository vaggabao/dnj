...
<head>
    ...
    <title>Contact Us | D&amp;J Lancaster Home Suite</title>
...
<div id="inner-wrap">
    ...
    <div id="main" role="main">
        <article class="block">
			<!-- message owner div -->
                    <div class="reserv-border text-center" style="margin: 5px; padding: 5px;">
                        ...
                        <form class="form" role="form" method="POST">
                            <div id="detailsDiv">
                                <script type="text/javascript" src=<?php echo LNK_ROOT . "/js/message-owner.js"; ?>></script>
                                <style>
                                    .element-hide {
                                        display: none;
                                    }
			...
			<div class="textmain">
				...
				<div>
                    ...
                    <div class="default-font text-center">
                            <a id="btn-map">
                                <img src=<?php echo LNK_ROOT . "/image/map.jpg";?> width="200px" height="200px" align="center"/>
